...
Dans cette section nous ne détaillerons que les configurations des \glspl{se}, et pas l'installation d'\gls{openstack} qui sera abordé dans la section \ref{sec:depblade}.
