...
\noindent Behind what we call \gls{cloudcomputing} there is a lot of interesting topics like virtualization, high-disponibility, and scalability.
...
\noindent Mots clés : Cloud Computing, Virtualisation, Réseau, OpenStack, Linux, UNIX, BladeCenter, Puppet, Juju, Shinken, Monitoring\newline
